    ...
    string fields, Guid companyId, HttpContext httpContext)
        {
            ...
            if (ShouldGenerateLinks(httpContext))
                return ReturnLinkdedEmployees(employeeDto, fields, companyId, httpContext,
                    shapedEmployees);
            ...
            Guid id, string fields = "")
        {
            var links = new List<Link>
            {
                ...
                "self",
                "GET"),
                new Link(_linkGenerator.GetUriByAction(httpContext,"DeleteCompanyForCompany",
